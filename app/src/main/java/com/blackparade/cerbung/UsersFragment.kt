...
import com.blackparade.cerbung.databinding.FragmentUsersBinding
...
//            param2 = it.getString(ARG_PARAM2)
        ...
        val url = "https://ubaya.me/native/160421109/cerbung/getUser.php"
        var stringRequest = StringRequest(
            ...
            Response.Listener<String>{
                ...
                if (obj.getString("result") == "OK"){
                    ...
                    Log.d("apiresult", users.toString())
                    updateListUser()
                }
            },
